...
const MainContent = () => {
  ...
  <div className="inline-block group cursor-default">
    ...
    <h1 className="text-5xl sm:text-7xl font-bold tracking-[0.2em] font-bubble transition-all duration-500">
      {/* الجزء الأول: وردي ناعم جداً مع حدود بيضاء رقيقة */}
      <span className="text-[#ffb7c5] drop-shadow-[2px_2px_0px_#ffffff]">
        SILLA
      </span>
      ...
      {/* الجزء الثاني: وردي مرجاني فاتح مع نبض هادئ جداً */}
      <span className="text-[#ff8da1] relative inline-block animate-soft-pulse">
        OUTFITS
        {/* خط سفلي فني تحت كلمة OUTFITS */}
    ...
    {/* الوصف: رمادي فاتح يميل للوردي ليكون هادئاً جداً */}
  ...
  {/* إضافة ستايل الأنيميشن الجديد للهيدر */}
  <style jsx>{`
